...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public List<SurahInfo> searchedSurah(String search)
    {
        ...
        Cursor c = sqLiteDatabase.rawQuery("Select SurahID,SurahNameE,SurahNameU,Nazool from tsurah as S join tayah as A on S.SurahID=A.SuraID AND A.AyaNo=1 where SurahNameE like '%"+search+"%'",null);
        if(c.moveToFirst())
        {
            do{
